              ...
              <tbody className="divide-y divide-mm-gray/20">
                {historyData.map((day) => (
                  <tr key={day.date} className="hover:bg-mm-dark2/30 transition-colors">
                    ...
                    <td className="p-4">
                      <span className={`font-medium ${day.foodConsumed > 0 ? 'text-red-500' : 'text-mm-gray'}`}>
                        {day.foodConsumed > 0 ? `${day.foodConsumed} cal` : '—'}
                      </span>
                    </td>
                    <td className="p-4">
                      <span className={`font-medium ${day.exerciseBurnt > 0 ? 'text-green-500' : 'text-mm-gray'}`}>
                    ...
                    <td className="p-4">
                      {day.foodConsumed === 0 && day.exerciseBurnt === 0 ? (
                        ...
                        <div className="text-sm">
                          <div className={`font-medium ${day.calorieBalance >= 0 ? 'text-mm-blue' : 'text-red-500'}`}>
